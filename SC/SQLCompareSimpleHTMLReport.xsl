...
<xsl:param name="Data"><xsl:text>Data</xsl:text></xsl:param>
...
<xsl:param name="ExtendedProperty"><xsl:text>Extended Property</xsl:text></xsl:param>
...
<xsl:param name="SearchPropertyList"><xsl:text>Search Property List</xsl:text></xsl:param>
<xsl:param name="Sequence"><xsl:text>Sequence</xsl:text></xsl:param>
...
<xsl:template name="objectTypeToString">
  ...
  <xsl:choose>
	...
	<xsl:when test="$node/@objecttype = 'data'"><xsl:value-of select="$Data" /></xsl:when>
	...
	<xsl:when test="$node/@objecttype = 'extendedproperty'"><xsl:value-of select="$ExtendedProperty" /></xsl:when>
	...
	<xsl:when test="$node/@objecttype = 'searchpropertylist'"><xsl:value-of select="$SearchPropertyList" /></xsl:when>
	<xsl:when test="$node/@objecttype = 'sequence'"><xsl:value-of select="$Sequence" /></xsl:when>
